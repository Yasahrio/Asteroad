...
# Load images
life_icon = pygame.display.set_mode((screen_width,screen_height))
life_icon = pygame.image.load('graphics/life/life.png')
...
hp_bar = pygame.image.load('graphics/hp.png')
